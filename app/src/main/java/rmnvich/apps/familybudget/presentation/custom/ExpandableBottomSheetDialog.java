package rmnvich.apps.familybudget.presentation.custom;
...
public class ExpandableBottomSheetDialog extends AppCompatDialog {
    ...
    public ExpandableBottomSheetDialog(@NonNull Context context) {
        this(context, 0);
    }

    private ExpandableBottomSheetDialog(@NonNull Context context, @StyleRes int theme) {
    ...
    private View wrapInBottomSheet(int layoutResId, View view, ViewGroup.LayoutParams params) {
        @SuppressLint("PrivateResource") final FrameLayout container = (FrameLayout) View.inflate(getContext(),
